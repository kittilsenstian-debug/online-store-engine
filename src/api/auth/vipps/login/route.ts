 ...
 * POST /auth/vipps/login
 * This endpoint is outside /store/ so it doesn't require publishable API key
 * Called from the OAuth callback handler to create a session token
 */
